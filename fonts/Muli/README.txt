...
This download contains Muli as both variable fonts and static fonts.

Muli is a variable font with this axis:
  wght

This means all the styles are contained in these files:
  Muli-VariableFont_wght.ttf
  Muli-Italic-VariableFont_wght.ttf

If your app fully supports variable fonts, you can now pick intermediate styles
that aren’t available as static fonts. Not all apps support variable fonts, and
in those cases you can use the static font files for Muli:
